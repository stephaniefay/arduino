...
int grnPin = 12;  // Green LED, connected to digital pin 10
int bluPin = 13;  // Blue LED,  connected to digital pin 11
...
void crossFade(int color[3]) {
  ...
  for (int i = 0; i <= 1020; i++) {
    ...
    digitalWrite(redPin, redVal);   // Write current values to LED pins
